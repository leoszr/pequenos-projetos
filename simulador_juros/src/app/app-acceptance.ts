...
export const appProductReadiness: ToolcraftProductReadiness = {
  mode: "product",
  productName: "Simulador de Juros Compostos",
  productSummary: "Financial dashboard that simulates simple and compound interest, taxes, inflation, scenario overlays, and PNG export.",
  requestedBehavior: "Left controls edit capital, period, interest, taxes, inflation, scenario comparison, background, and image export while the canvas initially fits beside the panel and shows a BRL summary, accessible line chart, composition, assumptions, and simple-vs-compound comparison.",
};

export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
{
  id: "capital-initialValue",
  kind: "control",
  target: "capital.initialValue",
  componentType: "text",
  fixture: "Default finance dashboard",
  userAction: "Change Valor inicial in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects capital.initialValue.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers capital.initialValue",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",

},
{
  id: "capital-monthlyContribution",
  kind: "control",
  target: "capital.monthlyContribution",
  componentType: "text",
  fixture: "Default finance dashboard",
  userAction: "Change Aporte mensal in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects capital.monthlyContribution.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers capital.monthlyContribution",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",

},
{
  id: "period-durationMonths",
  kind: "control",
  target: "period.durationMonths",
  componentType: "slider",
  fixture: "Default finance dashboard",
  userAction: "Change Duração in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects period.durationMonths.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers period.durationMonths",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",

},
{
  id: "period-durationUnit",
  kind: "control",
  target: "period.durationUnit",
  componentType: "segmented",
  fixture: "Default finance dashboard",
  userAction: "Change Unidade in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects period.durationUnit.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers period.durationUnit",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
...
},
{
  ...
  componentType: "segmented",
  fixture: "Default finance dashboard",
  userAction: "Change Tipo in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects interest.type.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers interest.type",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
  optionCoverage: "each-visible-item",
},
{
  id: "interest-annualRate",
  kind: "control",
  target: "interest.annualRate",
  componentType: "slider",
  fixture: "Default finance dashboard",
  userAction: "Change Taxa a.a. in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects interest.annualRate.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers interest.annualRate",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",

},
{
  id: "interest-benchmark",
  kind: "control",
  target: "interest.benchmark",
  componentType: "select",
  fixture: "Default finance dashboard",
  userAction: "Change Indexador in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects interest.benchmark.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers interest.benchmark",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
  optionCoverage: "each-visible-item",
},
{
  id: "interest-benchmarkModifier",
  kind: "control",
  target: "interest.benchmarkModifier",
  componentType: "slider",
  fixture: "Default finance dashboard",
  userAction: "Change % do índice in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects interest.benchmarkModifier.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers interest.benchmarkModifier",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
...
},
{
  ...
  componentType: "select",
  fixture: "Default finance dashboard",
  userAction: "Change IR in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects tax.irRate.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers tax.irRate",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
  optionCoverage: "each-visible-item",
},
{
  id: "tax-manualOverride",
  kind: "control",
  target: "tax.manualOverride",
  componentType: "switch",
  fixture: "Default finance dashboard",
  userAction: "Change Manual in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects tax.manualOverride.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers tax.manualOverride",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
...
},
{
  ...
  componentType: "slider",
  fixture: "Default finance dashboard",
  userAction: "Enable Manual, change IR manual, then disable Manual to prove hidden/unavailable behavior.",
  expectedObservable: "The IR manual control becomes visible when Manual is on, hides when Manual is off, and its value changes net return output.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers tax.manualRate",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
...
},
{
  ...
  componentType: "switch",
  fixture: "Default finance dashboard",
  userAction: "Change IOF in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects tax.iof.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers tax.iof",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",

},
{
  id: "inflation-annualRate",
  kind: "control",
  target: "inflation.annualRate",
  componentType: "slider",
  fixture: "Default finance dashboard",
  userAction: "Change Inflação a.a. in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects inflation.annualRate.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers inflation.annualRate",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
...
},
{
  ...
  componentType: "text",
  fixture: "Default finance dashboard",
  userAction: "Change Nome in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects scenario.name.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers scenario.name",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
...
},
{
  ...
  fixture: "Default finance dashboard",
  userAction: "Change Comparação in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects scenario.action.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers scenario.action",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
  actionCoverage: ["save-scenario"],
},
{
  ...
  componentType: "switch",
  fixture: "Default finance dashboard",
  userAction: "Turn Include off and export a PNG while checking preview background transparency behavior.",
  expectedObservable: "Disabling Include hides the live preview product background, makes PNG output transparent, and video output would keep product background because this still app has no video export.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers export.includeBackground",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
...
},
{
  ...
  componentType: "color",
  fixture: "Default finance dashboard",
  userAction: "Change Background in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects appearance.background.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers appearance.background",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
...
},
{
  ...
  componentType: "select",
  fixture: "Default finance dashboard",
  userAction: "Change Format in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects export.image.format.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers export.image.format",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
  optionCoverage: "each-visible-item",
},
{
  ...
  componentType: "select",
  fixture: "Default finance dashboard",
  userAction: "Change Resolution in the real controls panel.",
  expectedObservable: "The financial dashboard cards, charts, table, saved overlay, background, or export behavior reflects export.image.resolution.",
  evidence: "product-output",
  automated: true,
  automatedTestName: "app acceptance covers export.image.resolution",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
  optionCoverage: "each-visible-item",
},
{
  ...
  fixture: "Default dashboard export footer",
  userAction: "Click Exportar in the sticky footer.",
  expectedObservable: "Footer action returns the PNG export Promise and produces image bytes from the finance dashboard.",
  evidence: "exported-bytes",
  automated: true,
  automatedTestName: "app acceptance covers export.actions",
  browser: true,
  browserTestName: "browser: export button downloads finance PNG",
...
},
{
  ...
  kind: "runtime",
  componentType: "panelActions",
  fixture: "Default dashboard with Image Export set to PNG and 4K",
  userAction: "Click Exportar in the sticky footer.",
  expectedObservable: "A PNG/JPG blob is generated with selected resolution and the footer pending indicator tracks progress.",
  evidence: "exported-bytes",
  automated: true,
  automatedTestName: "app acceptance covers export action",
  browser: true,
  browserTestName: "browser: export button downloads finance PNG",
},
{
  ...
  fixture: "Changed initial value persisted to localStorage",
  userAction: "Change Valor inicial and reload the page.",
  expectedObservable: "The edited BRL value remains visible in the dashboard after reload.",
  evidence: "persistence-state",
  automated: true,
  automatedTestName: "app acceptance covers reload persistence",
  browser: true,
  browserTestName: "browser: finance settings persist after reload",
  persistenceCoverage: "reload",
},
{
  id: "canvas-initial-fit",
  kind: "runtime",
  componentType: "canvas",
  fixture: "Fresh 1920x1080 finance dashboard in a 1440x900 browser viewport",
  userAction: "Open the app with the default canvas viewport.",
  expectedObservable: "The complete finance canvas fits beside the floating controls panel without clipping, overlap, page overflow, or wheel and pointer panning into blank space while preserving editable output dimensions.",
  evidence: "viewport-side-effect",
  automated: true,
  automatedTestName: "finance viewport initially fits the canvas beside the controls panel",
  browser: true,
  browserTestName: "browser: finance canvas initially fits beside controls",
},
{
  id: "canvas-compact-preview",
  kind: "runtime",
  componentType: "canvas",
  fixture: "Fresh finance dashboard in a 390x844 compact browser viewport",
  userAction: "Open the app, scroll the dashboard, and expand the bottom controls sheet.",
  expectedObservable: "The compact dashboard fills the viewport at readable 1:1 scale, scrolls only inside product content, stays anchored at the canvas origin, and exposes all controls in an in-bounds bottom sheet.",
  evidence: "viewport-side-effect",
  automated: true,
  automatedTestName: "finance compact preview anchors dashboard and controls",
  browser: true,
  browserTestName: "browser: finance mobile dashboard stays anchored and controls remain usable",
},
{
  ...
  componentType: "slider",
  fixture: "Runtime resolution scale control",
  userAction: "Drag Resolution scale in Setup.",
  expectedObservable: "The runtime canvas backing scale updates without changing output CSS size.",
  evidence: "viewport-side-effect",
  automated: true,
  automatedTestName: "app acceptance covers canvas.renderScale",
  browser: true,
  browserTestName: "browser: finance product controls update dashboard",
},
];
...
export const starterControlSectionInventory: readonly ToolcraftControlSectionInventoryEntry[] = [
  {
    title: "Capital",
    entity: "Capital base",
    targets: ["capital.initialValue", "capital.monthlyContribution"],
    groupingReason: "Initial capital and contribution define invested principal.",
  },
  {
    title: "Prazo",
    entity: "Investment period",
    targets: ["period.durationMonths", "period.durationUnit"],
    groupingReason: "Duration value and display unit describe the simulation horizon.",
  },
  {
    title: "Juros",
    entity: "Interest model",
    targets: ["interest.type", "interest.annualRate", "interest.benchmark", "interest.benchmarkModifier"],
    groupingReason: "Interest type, rate, indexer and modifier produce the effective rate.",
  },
  {
    title: "Impostos e Inflação",
    entity: "Deductions and real return",
    targets: ["tax.irRate", "tax.manualOverride", "tax.manualRate", "tax.iof", "inflation.annualRate"],
    groupingReason: "Tax and inflation settings convert gross result into net and real values.",
  },
  {
    title: "Cenários",
    entity: "Scenario comparison",
    targets: ["scenario.name", "scenario.action"],
    groupingReason: "Name plus save action create chart overlays for comparison.",
  },
  {
    title: "Background",
    entity: "Output background",
    targets: ["export.includeBackground", "appearance.background"],
    groupingReason: "Required background controls drive preview and PNG background behavior.",
  },
  {
    title: "Image Export",
    entity: "PNG/JPG delivery",
    targets: ["export.image.format", "export.image.resolution"],
    groupingReason: "Format and resolution configure final image export.",
  },
];
...
export function validateToolcraftAcceptanceCoverage(
  ...
  const appAcceptanceIds = new Set(appAcceptance.map((entry) => entry.id));
  const effectiveAcceptance =
    schema === appSchema
      ? acceptance
      : acceptance.filter((entry) => !appAcceptanceIds.has(entry.id));
  const effectiveSectionInventory =
    sectionInventory !== starterControlSectionInventory
      ? sectionInventory
      : schema === appSchema && acceptance === appAcceptance
        ? sectionInventory
        : [];
  const errors: string[] = [];
  ...
  errors.push(...getToolcraftControlSectionGroupingErrors(schema, effectiveSectionInventory));
  errors.push(...getToolcraftControlSectionInventoryErrors(schema, effectiveSectionInventory));
  ...
  if (transferMode.mode === "reference-runtime-clone") {
    ...
    for (const coverage of declaredReferenceCoverage) {
      const entry = effectiveAcceptance.find(
    ...
    for (const entry of effectiveAcceptance) {
      if (
  ...
  if (timelineMode) {
    const playbackEntry = effectiveAcceptance.find(
  ...
  if (schema.canvas.sizing.mode === "fixed-output") {
    ...
    const fixedCanvasSizingEntry = effectiveAcceptance.find(
      (entry) =>
        entry.kind === "runtime" &&
  ...
  if (
    ...
    const intrinsicCanvasSizingEntry = effectiveAcceptance.find(
      (entry) =>
        entry.kind === "runtime" &&
  ...
  if (schema.persistence.storage === "localStorage") {
    const persistenceEntry = effectiveAcceptance.find(
      (entry) =>
        entry.kind === "runtime" &&
  ...
  if (timelineMode === "keyframes") {
    const hasKeyframesCoverage = effectiveAcceptance.some(
