...
| Handoff | 17464b13 concentrou início, callback autenticado, status Herdr, manifest/artifacts, inspeção e aceite em src/domain/handoff-cycle.ts. tests/domain/handoff-cycle.test.ts:214-718 cobre token/pane/ciclo, ordem claim/settle (idle|done), reload, inspeção concorrente, reviewer e aceite. TD-001 foi resolvida em 51bb0b32/17464b13: HANDOFF_READY é claim, não aceite. **Forte no domínio.** |
